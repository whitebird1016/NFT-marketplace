...
* Clone the repository:
  * ```$ git clone https://github.com/whitebird1016/NFT-marketplace ```
...
This project is under the **MIT license**. See the [LICENSE](https://github.com/whitebird1016/NFT-marketplace/blob/master/LICENSE) for more information.
...
<a href="mailto:takus.superdev@gmail.com" target="_blank" >
